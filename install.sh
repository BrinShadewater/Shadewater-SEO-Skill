...
REPO_URL="${REPO_URL:-https://github.com/BrinShadewater/Shadewater-SEO-Skill.git}"
...
Examples:
  ...
  bash install.sh --target claude --repo-path /path/to/checkout

  # Install from a custom remote repository URL
  bash install.sh --target codex --source remote --repo-url https://github.com/you/your-fork.git
EOF
}
