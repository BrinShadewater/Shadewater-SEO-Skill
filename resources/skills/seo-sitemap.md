...
Read `resources/references/indexnow.md` before recommending IndexNow, and `resources/references/provider-guidance-matrix.md` before provider-specific sitemap/indexing claims.
...
- Freshness-sensitive sites pair accurate sitemaps with IndexNow for Bing/Yandex URL change notification
...
| No IndexNow workflow on frequently updated Bing/Yandex-targeted site | Info/Medium | Add IndexNow for changed URLs only |
...
7. For Bing/Yandex freshness-sensitive sites, document an optional IndexNow submission flow
8. Generate STRUCTURE.md documentation
...
5. If the site is news, ecommerce, programmatic, or frequently updated and targets Bing/Yandex, recommend IndexNow as a freshness mechanism, not a ranking guarantee.
