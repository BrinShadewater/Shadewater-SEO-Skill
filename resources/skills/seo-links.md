...
```bash
python <SKILL_DIR>/scripts/internal_links.py <url> --depth 2 --json
```
...
```bash
python <SKILL_DIR>/scripts/broken_links.py <url> --json
```
...
```bash
python <SKILL_DIR>/scripts/link_profile.py <url> --json
```
