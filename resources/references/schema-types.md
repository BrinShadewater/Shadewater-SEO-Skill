...
Primary Google source checked: https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data

## Format Preference
Prefer **JSON-LD** (`<script type="application/ld+json">`) for new implementations because Google says it is usually easiest to implement and maintain at scale.

Google supports JSON-LD, Microdata, and RDFa when valid and properly implemented for the relevant feature. Do not claim structured data is special AI markup or guarantees generative AI visibility.
...
|------|--------|-------|-------|
| FAQPage | Rich results fully removed | May 7, 2026 | Deprecation notice added to Google docs; FAQ rich results no longer shown for any site (the 2023 gov/healthcare carve-out is gone). Search Console FAQ report and Rich Results Test support removed June 2026; Search Console API data removal August 2026. FAQPage remains a valid Schema.org type — existing markup is harmless but earns nothing. Google states rankings are unaffected. |
