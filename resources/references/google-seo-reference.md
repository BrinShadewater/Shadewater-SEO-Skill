...
- Make pages easy for search engines to crawl, index, and understand
...
- Use valid structured data to become eligible for supported rich result features when it matches visible content
...
- Do not use Core Web Vitals as a substitute for relevance, usefulness, or content quality
