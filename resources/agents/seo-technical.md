...
|--------|---------|---------|
| `parse_html.py` | HTML element extraction + JSON-LD validation | `python parse_html.py --url <url> --json` |
| `hreflang_checker.py` | International SEO validation | `python hreflang_checker.py <url> --json` |
| `indexnow_checker.py` | IndexNow implementation check | `python indexnow_checker.py <url> --key <key> --json` |
| `duplicate_content.py` | Near-duplicate & thin content detection | `python duplicate_content.py <url> --json` |

## Core Web Vitals Reference

Current thresholds (as of July 2026):
