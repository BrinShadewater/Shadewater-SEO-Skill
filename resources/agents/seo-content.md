...
|--------|---------|---------|
| `article_seo.py` | Article extraction, readability, SEO issues | `python article_seo.py <url> --json` |
| `entity_checker.py` | Entity presence, sameAs, Knowledge Graph | `python entity_checker.py <url> --json` |
| `competitor_gap.py` | Content gap analysis vs competitors | `python competitor_gap.py <url> --competitor <url> --json` |
...
- Structured data (`Article`, `speakable`; FAQ rich results retired May 2026 — use visible Q&A content instead of FAQPage)
- Brand mentions with consistent entity naming
- `llms.txt` file at site root (optional/experimental — Google's May 2026 AI guide confirms it does nothing for Google Search)
