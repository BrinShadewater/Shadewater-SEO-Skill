...
|--------|---------|---------|
| `capture_screenshot.py` | Browser screenshots (desktop + mobile) | `python capture_screenshot.py <url>` |
| `analyze_visual.py` | Visual + DOM comparison analysis | `python analyze_visual.py <url>` |
