...
|--------|---------|---------|
| `parse_html.py` | Extract page metadata and canonicals | `python parse_html.py --url <url> --json` |
| `broken_links.py` | Verify URL status codes | `python broken_links.py <url> --json` |
| `duplicate_content.py` | Detect thin/duplicate content | `python duplicate_content.py <url> --json` |
