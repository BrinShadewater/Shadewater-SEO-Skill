...
RESTRICTED_SCHEMA = {"FAQPage"}  # FAQ rich results fully retired May 2026
    ...
    if not structured_data:
        ...
        for sd in structured_data:
            if sd.get("status") == "deprecated":
                ...
                issues.append({"severity": "Info", "area": "Schema", "finding": sd["note"], "fix": "FAQPage no longer earns rich results anywhere (retired May 2026). Existing markup is harmless; do not add it to new pages."})
